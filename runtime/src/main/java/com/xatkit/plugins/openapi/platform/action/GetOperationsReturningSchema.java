...
public class GetOperationsReturningSchema extends RuntimeAction<OpenAPIPlatform>{
	
	private String schemaName;

	public GetOperationsReturningSchema(OpenAPIPlatform runtimePlatform, XatkitSession session, String schemaName) {
	...
	protected Map<String, Object> compute() throws Exception {
		 ...
		 if(schema == null) {
			 ...
			 List<Operation> operations = OpenAPIUtils.getAllOperationsReturningSchema(api, schema);
